...
const provideHass = (element) => { var _a; return (_a = 
// @ts-ignore
document.querySelector('home-assistant')) === null || _a === void 0 ? void 0 : _a.provideHass(element); };

let GoogleHomeGridItem = class GoogleHomeGridItem extends LitElement {
    constructor() {
        super(...arguments);
        this.setConfig = (config) => {
            ...
            if (config && config.actions && config.actions.length > 2) {
                console.warn('More than 2 actions specified. Only the first two will be rendered.');
            }
            if (!this.hass)
                provideHass(this);
            this._config = config;
        ...
        this.render = () => {
            ...
            const actions = ((_a = this._config) === null || _a === void 0 ? void 0 : _a.actions) ? (_c = (_b = this._config) === null || _b === void 0 ? void 0 : _b.actions) === null || _c === void 0 ? void 0 : _c.slice(0, 2) : [];
            const entity = (_d = this.hass) === null || _d === void 0 ? void 0 : _d.states[this._config.entity];
            const isMdiIcon = (_e = this._config) === null || _e === void 0 ? void 0 : _e.icon.startsWith('mdi:');
            return html `
            <div id="wrapper">
                <button @click=${this._handleButtonClick} type="button">
                    ${isMdiIcon
                ? html `
                              <ha-icon icon=${(_f = this._config) === null || _f === void 0 ? void 0 : _f.icon}></ha-icon>
                          `
                : html `
                              <img src=${(_g = this._config) === null || _g === void 0 ? void 0 : _g.icon} />
                          `}
                    <h4>
                        ${((_h = this._config) === null || _h === void 0 ? void 0 : _h.name) || ((_j = entity) === null || _j === void 0 ? void 0 : _j.attributes.friendly_name)}
                    </h4>
                </button>
                <ul class="actions">
                    ${actions.map(({ label, state, service }) => {
                var _a;
                if (!state || ((_a = entity) === null || _a === void 0 ? void 0 : _a.state) === state)
                    return html `
                                <button
        ...
        this._handleButtonClick = () => A(this, 'hass-more-info', {
        ...
        this._handleActionClick = (serviceString) => {
            const entityId = this._config.entity;
            const [domain, service] = serviceString.split('.');
            return () => { var _a; return (_a = this.hass) === null || _a === void 0 ? void 0 : _a.callService(domain, service, { entity_id: entityId }); };
        };
    }
    static get styles() {
        return css `
...
__decorate([
    property()
], GoogleHomeGridItem.prototype, "hass", void 0);
__decorate([
    property()
], GoogleHomeGridItem.prototype, "_config", void 0);
GoogleHomeGridItem = __decorate([
    customElement('google-home-grid-item')
], GoogleHomeGridItem);

const LitElement$1 = customElements.get('home-assistant-main') ? Object.getPrototypeOf(customElements.get('home-assistant-main')) : Object.getPrototypeOf(customElements.get('hui-view'));
...
class ThingMaker extends LitElement$1 {
  ...
  setConfig(config) {
    ...
    if(!this.el) {
      ...
      if(this.noHass) provideHass$1(this);
    } else {
...
let GoogleHomeGrid = class GoogleHomeGrid extends LitElement {
    constructor() {
        super(...arguments);
        this.setConfig = (config) => {
            if (!config || !config.cards || !Array.isArray(config.cards))
                throw new Error('Invalid configuration');
            this._config = config;
            this._cards = config.cards.map(cardConfig => O(cardConfig));
        };
        this.shouldUpdate = (changedProperties) => changedProperties.has('_config');
        this.render = () => {
            var _a, _b, _c;
            return html `
        <div id="wrapper">
            <h2>${(_a = this._config) === null || _a === void 0 ? void 0 : _a.title}</h2>
            <h3>
                ${(_b = this._cards) === null || _b === void 0 ? void 0 : _b.length}
                ${((_c = this._cards) === null || _c === void 0 ? void 0 : _c.length) === 1 ? 'device' : 'devices'}
            </h3>
            <div class="grid">
                ${this._cards}
            </div>
...
__decorate([
    property()
], GoogleHomeGrid.prototype, "hass", void 0);
__decorate([
    property()
], GoogleHomeGrid.prototype, "_config", void 0);
__decorate([
    property()
], GoogleHomeGrid.prototype, "_cards", void 0);
GoogleHomeGrid = __decorate([
    customElement('google-home-grid')
], GoogleHomeGrid);

let GoogleHomeMenuItem = class GoogleHomeMenuItem extends LitElement {
    constructor() {
        super(...arguments);
        this.setConfig = (config) => {
            // TODO: Evaluate configuration
            if (!config)
                throw new Error('Invalid configuration');
            if (!config.entity)
                throw new Error(`Invalid configuration: field \`entity\`is required`);
            if (!config.icon)
        ...
        this.render = () => {
            ...
            const derivedStyles = getDerivedStyles((_a = this._config) === null || _a === void 0 ? void 0 : _a.color);
            return html `
            <button
                @click=${this._handleClick}
                data-color=${(_b = this._config) === null || _b === void 0 ? void 0 : _b.color}
                type="button"
            >
                <ha-icon
                    icon=${(_c = this._config) === null || _c === void 0 ? void 0 : _c.icon}
                    style=${derivedStyles}
                ></ha-icon>
                <span
                    >${((_d = this._config) === null || _d === void 0 ? void 0 : _d.name) || ((_e = this.hass) === null || _e === void 0 ? void 0 : _e.states[(_f = this._config) === null || _f === void 0 ? void 0 : _f.entity].attributes.friendly_name)}</span
                >
            </button>
        `;
        };
        this._handleClick = () => A(this, 'hass-more-info', {
            entityId: this._config.entity,
        }, {
            bubbles: true,
            cancelable: false,
...
__decorate([
    property()
], GoogleHomeMenuItem.prototype, "hass", void 0);
__decorate([
    property()
], GoogleHomeMenuItem.prototype, "_config", void 0);
GoogleHomeMenuItem = __decorate([
    customElement('google-home-menu-item')
], GoogleHomeMenuItem);

let GoogleHomeMenu = class GoogleHomeMenu extends LitElement {
    constructor() {
        super(...arguments);
        this.setConfig = (config) => {
            if (!config || !config.cards || !Array.isArray(config.cards))
        ...
        this.render = () => {
            ...
            return html `
        <div id="wrapper">
            <h1>${(_a = this._config) === null || _a === void 0 ? void 0 : _a.title}</h1>
            <div class="flex">
                ${this._cards}
            </div>
        </div>
...
__decorate([
    property()
], GoogleHomeMenu.prototype, "hass", void 0);
__decorate([
    property()
], GoogleHomeMenu.prototype, "_config", void 0);
__decorate([
    property()
], GoogleHomeMenu.prototype, "_cards", void 0);
GoogleHomeMenu = __decorate([
    customElement('google-home-menu')
], GoogleHomeMenu);

export { GoogleHomeGrid, GoogleHomeGridItem, GoogleHomeMenu, GoogleHomeMenuItem };
