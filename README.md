...
3. Look around and find the [Lottie](https://airbnb.design/lottie/) animations and use [this online tool](https://lottie-to-svg.netlify.com) I created to get the static SVG files and upload the SVG's to your Home Assistant's `www` folder and reference them in the card configurations (see example above).
